defmodule VestaboardAgent.Agents.SportsAgent do
  ...
  @team_lookup [
    ...
    # NYG; MLB Giants → "sf giants"
    {"giants", {"football", "nfl", "NYG"}},
    # NYJ; NHL Jets → "winnipeg jets"
    ...
    # SAC; NHL Kings → "la kings"
    {"kings", {"basketball", "nba", "SAC"}},
    ...
    # unreachable — NFL cardinals match first
    {"cardinals", {"baseball", "mlb", "STL"}},
    {"cards", {"baseball", "mlb", "STL"}},
    {"rays", {"baseball", "mlb", "TB"}},
    # TEX; NHL Rangers → "new york rangers"
